...
import com.lisungui.pharma.utility.DataParser;
...
//    ArrayList<LatLongPojo> locArrayList = new ArrayList<>();
...
//
//        locArrayList.add(new LatLongPojo("CCD", 18.5024588, 73.9010127));
//        locArrayList.add(new LatLongPojo("Pizza Hut", 18.5026553, 73.8983439));
//        locArrayList.add(new LatLongPojo("Mcdonalds", 18.4908881, 73.8980538));
//        locArrayList.add(new LatLongPojo("Chroma", 18.512931, 73.9110287));
//        locArrayList.add(new LatLongPojo("Amanora Park Town", 18.5191497, 73.9319827));

//        locArrayList.add(new LatLongPojo("Pind Punjabi", 18.5701429, 73.7705014));
//        locArrayList.add(new LatLongPojo("Wadeshwar", 18.5554492, 73.7928825));
//        locArrayList.add(new LatLongPojo("The Orchid Hotel", 18.57087, 73.761721));
//        locArrayList.add(new LatLongPojo("Sayaji Hotel", 18.5995029, 73.752941));
    ...
    public void onLocationChanged(Location location) {
        ...
        markerOptions.title(getString(R.string.str_i_am_here));
        ...
        getNearLocations(location.getLatitude(), location.getLongitude());
        ...
        call.enqueue(new Callback<ListLocations>() {
            ...
            public void onResponse(Call<ListLocations> call, Response<ListLocations> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    ArrayList<LatLongPojo> longArrayList = listLoc.getPharmacy();

                    Log.d(TAG, "Response Array : " + longArrayList.toString());
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(this, getString(R.string.str_per_denied), Toast.LENGTH_LONG).show();
                }
                return;
            }
